...
(function() {
    ...
    if (!window.cnItems || Object.keys(window.cnItems).length === 0) {
        window.cnItems = {
            ...
            "": "",
            "": "",
            "Increase the maximum number of stored commission refresh charges": "提升委托刷新次数存储上限",
            "Resource(Metal)": "资源（金属类）",
            "- Unlock Processing and Smelting\n- Unlocked recipes: Copper, Silver, Smooth Stone, Tin and Iron": "- 解锁矿石加工与冶炼\n- 已解锁配方：铜、银、平滑石材、锡、铁",
            "Reduce the amount of input resources consumed by processing recipes": "减少加工配方所需消耗的原料数量",
            " All claimed ": "全部已领取",
            "- Unlock Processing and Smelti": "- 解锁矿石加工与冶炼功能",
            " Unlocked recipes: Copper, Silver, Smooth Stone, Tin and Iron": "已解锁配方：铜、银、平滑石材、锡、铁",
            "Add additional processing slots to handle multiple recipes simultaneously": "新增加工工位，可同时进行多份配方加工",
            "Bonus Chance": "额外产出概率",
            "Bonus Multiplier": "额外产出倍率",
            "Chance to get additional results from processing recipes": "加工配方时有概率获得额外成品",
            "Enhance your processing capabilities with powerful upgrades": "强力升级，全方位强化加工产能",
            "Increase the amount of bonus resources gained from processing": "提升加工所得额外资源数量",
            "Increase the amount of resources produced by processing recipes": "提升配方基础产出总量",
            "Increase the speed at which this processor completes recipes": "加快加工台完成配方的速度",
            "Input Efficiency": "原料利用率",
            "Output Multiplier": "产出倍率",
            "Parallel Slots": "并行加工工位",
            "Processing Speed": "加工速度",
            "Processor Upgrades": "加工台升级项",
            "Processor stats will go here": "此处显示加工台各项属性",
            " Copper Bar ": "铜锭",
            " Diamonds ": "钻石",
            " Emeralds ": "祖母绿",
            " Manufactured": "加工制品",
