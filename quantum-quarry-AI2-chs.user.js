...
(function() {
    ...
    if (!window.cnItems || Object.keys(window.cnItems).length === 0) {
        window.cnItems = {
            ...
            "Chlorophyte Ore": "叶绿矿",
            "Coal Gain +15%": "煤炭产出+15%",
            "Copper Ore Breaking Power +10%": "铜矿开采破坏力+10%",
            "Stone Gain +15%": "石材产出+15%",
            "Verdant crystalline ore infused with nature energy": "蕴含自然能量的翠绿色结晶矿石",
            " Chromaticite Ore ": "彩晶矿",
            "Aether Gain Multiplier +5%": "以太微粒获取倍率+5%",
            "Chromaticite Ore": "彩晶矿",
            "Chromaticite Ore Gain +10%": "彩晶矿产出+10%",
            ...
            "Ore Mine Breaking Power +10%": "矿石矿场破坏力+10%",
            "Pickaxe XP Gain +10%": "镐子经验获取+10%",
            "Unlock Gold Ore": "解锁金矿",
            "Coal Breaking Power +10%": "煤炭开采破坏力+10%",
            "Stone Breaking Power +10%": "石材开采破坏力+10%",
            ...
            "Nickel Ore Gain +10%": "镍矿石产出+10%",
            "Iron Ore Gain +10%": "铁矿石产出+10%",
            "Lapis Lazuli": "青金石",
            "Lapis Lazuli Gain +10%": "青金石产出+10%",
            ...
            "Pickaxe Crit Chance +2%": "镐子暴击概率+2%",
            "Pickaxe XP Gain +5%": "镐子经验获取+5%",
            ...
            "Ore Mine Gain +10%": "矿石矿场产出+10%",
            "Pickaxe Breaking Power +10%": "镐子破坏力+10%",
            "Pickaxe Breaking Power +5%": "镐子破坏力+5%",
            "Processing Output +5%": "加工产出+5%",
            "Soft silvery metal, essential for bronze alloys": "质地柔软的银白色金属，是炼制青铜合金的核心原料",
            "Tin Ore": "锡矿",
            "Tin Ore Gain +10%": "锡矿产出+10%",
